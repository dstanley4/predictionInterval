...
#' @param prob.level (optional 0 to 1 value) Probability level desired (0 to 1). If not specified .95 (i.e., 95 percent) will be used.
#' @param show.all.trials Show original correlation, replication interval, replication correlation, and whether replication effect is in the interval.
#' @return The replication interval and related statistics in list format.
#' @examples
...
get_orig_rep_m <- function(original_N,replication_N,mu,sigma,prob_level) {
     ...
     #confidence and replication intervals
